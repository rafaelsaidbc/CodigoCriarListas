...
public class JogadorAdapter extends ArrayAdapter<Jogador> {
     ...
     */
    public JogadorAdapter(Context context, ArrayList<Jogador> jogadores) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Jogador currentJogador = getItem(position);
        ...
        // Find the TextView in the layout_info_jogadores.xmlogadores.xml layout with the ID default_text_view.
        TextView numecroTextView = (TextView) listItemView.findViewById(R.id.numero_camisa_view);
        // Get the default translation from the currentJogador object and set this text on
        // the default TextView.
        numecroTextView.setText(currentJogador.getNumeroCamisa());
